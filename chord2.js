// code adopted from https://bitbucket.org/gghh/chord2/src
...
d3.chord2 = function() {
    ...
    function chord2(selection){
        ...
        selection.each(function (d, i) {
            ...
            selection.data(chord2.groups().map(groupLabels)).exit().remove(); // RB
    ...
    function relayout() {
        ...
        i = -1; while (++i < connections.length) {
            if (connections[i].length === 1) {
                //console.log(subgroups[connections[i][0].group]);
